...
public class House extends Services {
    ...
    public House(String id,String servicesName,double useArea,double price,int maxPeople,String rentalType,String standard, String description,  int numberFloors) {
        this.id = id;
    ...
    public void input() {
        ...
        if(!checkRegex(this.id, Regex.ID_HOUSE_REGEX)) {
            System.err.println("WRONG FORMAT!!! : ID format is SVHO-YYYY with YYYY is numbers");
            this.input();
        }
    ...
    private boolean checkFloorRegex(int numberFloors){
        return numberFloors > 0;
    }
