                ...
                <div class="col-lg-6">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <input type="text" id="fir" name="name" value="${requestScope.employee.name}">
                        </div>
                        <div class="col-lg-6">
                            <label for="last">ID Card<span>*</span></label>
                            <input type="text" id="last" name="card" value="${requestScope.employee.card}">
                        </div>
                        <div class="col-lg-12">
                            <label for="cun-name">Date Of Birth</label>
                            <input type="date" id="cun-name" name="birth" value="${requestScope.employee.birthday}">
                        </div>
                        <div class="col-lg-12">
                            <label for="cun">Salary<span>*</span></label>
                            <input type="number" id="cun" name="salary" value="${requestScope.employee.salary}">
                        </div>
                        <div class="col-lg-12">
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="text" id="email" name="email" value="${requestScope.employee.email}">
                        </div>
                        <div class="col-lg-6">
                            <label for="phone">Phone<span>*</span></label>
                            <input type="text" id="phone" name="phone" value="${requestScope.employee.phone}">
                        </div>
                        <div class="col-lg-12">
