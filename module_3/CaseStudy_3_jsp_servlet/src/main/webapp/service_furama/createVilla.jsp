        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcrumb-text product-more">
                    ...
                    <a href="/service?action=createVilla&serviceType=1">Service</a>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <label for="last">Area Villa<span>*</span></label>
                            <input type="number" id="last" name="area">
                        </div>
                        <div class="col-lg-6">
                            <label for="phone">Pool Area<span>*</span></label>
                            <input type="number" id="phone" name="poolArea">
                        </div>
                        <div class="col-lg-12">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="col-lg-4 offset-lg-4">
                        <button class="site-btn place-btn">Creat Villa</button>
                    </div>
                </div>
            </div>
        </form>
